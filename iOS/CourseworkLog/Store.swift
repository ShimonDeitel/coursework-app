...
final class Store: ObservableObject {
    ...
    private let fileName = "coursework_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Portfolio Piece One", detail: "First example entry.", date: now),
            Entry(title: "Sample Portfolio Piece Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Portfolio Piece Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
